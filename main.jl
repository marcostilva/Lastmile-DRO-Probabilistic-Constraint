...
tic()
result,initialsol= solveSTODROPCEXACTALLCOLUMNS(V,A,DESTC,PROBC,REWV,CAPV,PROBOD,REWOD)
TimeMain += toq()
println("Final Solution DRO Stochastic ALL COL = ",inst_id," ,", result,"  Time spent = ",TimeMain+TimePric+TimeSce,"  Time Main = ",TimeMain,"  Time Pric = ",TimePric,"  Time Comp = ",TimeSce," Nodes =",NODECOUNT,"; ",ROUTCOUNT,"; ",COMPCOUNT,"; ",NOROUTCOUNT,"; ",NOCOMPCOUNT,"; ",NROUTES,"; ",PERHIGH,";",ROOTSOL,";",ROOTTIME)
#read(STDIN,Char)
println(resultado,"Final Solution DRO Stochastic ALL COL = ",inst_id," ,", result,"  Time spent = ",TimeMain+TimePric,"  Time Main = ",TimeMain,"  Time Pric = ",TimePric,"  Time Comp = ",TimeSce," Nodes =",NODECOUNT,"; ",ROUTCOUNT,"; ",COMPCOUNT,"; ",NOROUTCOUNT,"; ",NOCOMPCOUNT,"; ",NROUTES,"; ",PERHIGH,";",ROOTSOL,";",ROOTTIME)
#####################################################################################################################################
